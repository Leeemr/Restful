CLASS zstrfi12_transaction_handler DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .

  PUBLIC SECTION.
    CLASS-DATA: go_instance TYPE REF TO zstrfi12_transaction_handler.

    CLASS-METHODS: get_instance RETURNING VALUE(result) TYPE REF TO zstrfi12_transaction_handler.
...
CLASS ZSTRFI12_TRANSACTION_HANDLER IMPLEMENTATION.
